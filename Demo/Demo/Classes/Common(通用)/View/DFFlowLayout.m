...
/** 默认的列数 */
static const NSInteger DSDefaultColumnount = 4;
/** 每一列之间的间距 */
static const CGFloat DSDefaultColumnMargin = 10;
/** 每一行之间的间距 */
static const CGFloat DSDefaultRowMargin = 10;
/** 边缘间距 */
static const UIEdgeInsets DSDefaultEdgeInsets = {10, 10, 10, 10};

@interface DFFlowLayout()
/** 存放所有cell的布局属性 */
